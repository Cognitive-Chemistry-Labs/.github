...
- Web and API interfaces for chemical data

## Featured Repositories
Explore our key projects:
- **padelpy2/**: Python wrapper for PaDEL-Descriptor
- **cognichem-client-python/**: Python client for CogniChem's platform

## Get Involved
We welcome contributions from the community! If you are interested in collaborating, please:
